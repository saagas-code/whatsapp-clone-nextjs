    ...
    <header className="h-[60px] py-0 px-[15px] flex justify-between items-center">
      ...
      <div className="flex">
        <div className="flex gap-4 items-center align-middle ">
          <Icon><MdDonutLarge /></Icon>
          <Icon><BsFillChatLeftTextFill onClick={() => setShowNewChat(true)} className="h-[25px] w-[25px]" /></Icon>
          <Icon><FiMoreVertical className="h-[25px] w-[25px]" /></Icon>
        </div>
      </div>
    </header>
  )
